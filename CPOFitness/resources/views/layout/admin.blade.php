...
<head>
  ...
  <title>CPO Fitness | Dashboard</title>
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__wobble" src="{{ asset('template/assets/img/cpo-logo.png') }}" alt="AdminLTELogo" height="60" width="60">
  </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ url('/') }}" class="brand-link">
      <img src="{{ asset('template/assets/img/cpo-logo.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-5" style="opacity: .8">
      <span class="brand-text font-weight-light">CPO Fitness</span>
    </a>
...
@yield('content')
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2023 <a href="https://adminlte.io">CPO Fitness</a>.</strong>
    All rights reserved.
